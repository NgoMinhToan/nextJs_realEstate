...
const PropertyDetails = ({propertyDetails: {purpose, price, rentFrequency, rooms, title, baths, area, agency, isVerified, desciption, type, furnishingStatus, amenities, photos}}) => (
    <Box maxWidth='1000px' margin='auto' p='4'>
        ...
        <Box w='full' p='6'>
            ...
            <Box marginTop='2'>
                ...
                <Text lineHeight='2' color='gray.600'>{desciption}</Text>
            </Box>
